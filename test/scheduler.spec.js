...
test('Calculate fun', () => {
    ...
    let PPmin = 0.1;
  expect(scheduler.calcPP(Start, End, PPmin)).toBe(6)
});
...
test('Calculate avalible PP full', () => {
  ...
  let start = '2018-08-06T10:00:00'
  expect(scheduler.PPAvalAfter(slots, start)).toBe(6)
});
...
test('Calculate avalible PP none', () => {
  ...
  expect(scheduler.PPAvalAfter(slots, start)).toBe(0)
});
...
test('Calculate avalible PP partial before', () => {
  ...
  expect(scheduler.PPAvalAfter(slots, start)).toBe(3)
});
...
test('Calculate avalible PP', () => {
  ...
  expect(scheduler.PPUsedAfter(jobs, start)).toBe(6)
});
...
test('Calculate avalible PP partial before', () => {
  ...
  expect(scheduler.PPUsedAfter(jobs, start)).toBe(3)
});
...
test('Calculate used PP partial', () => {
  ...
  expect(scheduler.PPUsedBetween(jobs, start, end)).toBe(9)
});
...
test('Calculate avalible PP between', () => {
  ...
  let start = '2018-08-06T10:00:00'
  let end = '2018-08-06T11:00:00'
  expect(scheduler.PPAvalBetween(slots, start, end)).toBe(16)
});