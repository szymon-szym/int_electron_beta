...
const PPAvalBetween = (avalArr, start, end) => {
    let result = avalArr.filter(e => {
...
const PPUsedBetween = (jobs, start, end) => {
    let result = jobs.filter(e => {
...
module.exports.PPUsedBetween = PPUsedBetween
module.exports.PPAvalBetween = PPAvalBetween
module.exports.PPAvalAfter = PPAvalAfter
module.exports.PPUsedAfter = PPUsedAfter
